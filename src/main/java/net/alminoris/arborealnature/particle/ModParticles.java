...
public class ModParticles
{
    ...
    public static final SimpleParticleType ARAUCARIA_NEEDLES = FabricParticleTypes.simple();
    public static final SimpleParticleType JUNIPER_NEEDLES = FabricParticleTypes.simple();
