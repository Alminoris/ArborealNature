...
public class ModFoliagePlacerTypes
{
    ...
    public static final FoliagePlacerType<?> VIBURNUM_FOLIAGE_PLACER = FoliagePlacerTypeInvoker.callRegister("viburnum_foliage_placer", ViburnumFoliagePlacer.CODEC);
