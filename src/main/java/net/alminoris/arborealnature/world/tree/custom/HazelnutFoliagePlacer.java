...
public class HazelnutFoliagePlacer extends FoliagePlacer
{
    public static final Codec<HazelnutFoliagePlacer> CODEC = RecordCodecBuilder.create(hazelnutFoliagePlacerInstance ->
            fillFoliagePlacerFields(hazelnutFoliagePlacerInstance).and(Codec.intRange(0, 12).fieldOf("height")
                    .forGetter(instance -> instance.height)).apply(hazelnutFoliagePlacerInstance, HazelnutFoliagePlacer::new));

    public static final MapCodec<HazelnutFoliagePlacer> MAP_CODEC = RecordCodecBuilder.mapCodec(hazelnutFoliagePlacerInstance ->
            fillFoliagePlacerFields(hazelnutFoliagePlacerInstance).and(Codec.intRange(0, 12).fieldOf("height")
                    .forGetter(instance -> instance.height)).apply(hazelnutFoliagePlacerInstance, HazelnutFoliagePlacer::new));
