...
public class CaribouSpearEntity extends PersistentProjectileEntity
{
    ...
    {
        super(ModEntities.CARIBOU_SPEAR, owner, world, stack, null);
        this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
        this.dataTracker.set(ENCHANTED, stack.hasGlint());
    }

    public CaribouSpearEntity(World world, double x, double y, double z, ItemStack stack)
    {
        super(ModEntities.CARIBOU_SPEAR, x, y, z, world, stack, stack);
        this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
        this.dataTracker.set(ENCHANTED, stack.hasGlint());
    }
    ...
    protected ItemStack getDefaultItemStack() {
        return new ItemStack(ModItems.CARIBOU_SPEAR);
    }
