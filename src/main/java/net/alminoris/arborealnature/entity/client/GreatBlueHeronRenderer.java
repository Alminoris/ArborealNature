...
public class GreatBlueHeronRenderer extends GeoEntityRenderer<GreatBlueHeronEntity>
{
    ...
    @Override
    public void preRender(MatrixStack poseStack, GreatBlueHeronEntity entity, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        if (entity.isBaby())
