...
{
    public static final MapCodec<SedgeBlock> CODEC = createCodec(SedgeBlock::new);
    ...
    @Override
    public MapCodec<SedgeBlock> getCodec() { return CODEC; }
    ...
    @Override
    protected BlockState getStateForNeighborUpdate(BlockState state, Direction dir, BlockState neighbor, WorldAccess world, BlockPos pos, BlockPos neighborPos)
    {
