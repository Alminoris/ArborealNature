...
import net.alminoris.arborealnature.state.propery.ModProperties;
...
public class FlowerbedBlock extends PlantBlock implements Fertilizable
{
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        return blockState.isOf(this) ? (BlockState)blockState.with(FLOWER_AMOUNT, Math.min(4, (Integer)blockState.get(FLOWER_AMOUNT) + 1)) : (BlockState)this.getDefaultState().with(FACING, ctx.getPlayer().getHorizontalFacing().getOpposite());
    }
    ...
    static {
        ...
        FLOWER_AMOUNT = ModProperties.FLOWER_AMOUNT;
    }
}
